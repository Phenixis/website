...
There are a lot of areas like finances, sports, or productivity for example where any software developer can build an app useful for anyone. Take for example [finary](https://finary.com/), an app for your finances, seems to be a great and refreshing app. I have never seen an app for finances that was interesting like this one, I don't have a subscription for Finary but if I wanted to take a subscription to improve my finances, this is the one I would go to. And this is because of their personal branding on YouTube.

# What I will do now

So now, my goal is to bring my software development skill to areas where there is a low competition, not to avoid competition, but to be in the first to be there, and so to take a big step ahead in these areas and make a difference. Some of these areas could be dressing, nutrition, productivity, motivation, personal management, ... This is a new motivation for me, and I'm really happy. My goal is still to solve my own problems, so that's it's useful for me at least.