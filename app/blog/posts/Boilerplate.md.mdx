...
I'm not directly working on this boilerplate, it's a project that gets improved and updated as I work on my other projects. For example, when I built WiseCart, I added a feature to manage user roles and permissions, and I thought it would be useful for the boilerplate, so I added it there. Same thing when I built my [Life OS](/blog/Life_OS) project, I improved the dark mode, improved the product and subscription management with Stripe, etc...

If ever you are interested in the boilerplate, it's one of the many bonuses I give away for free when you buy one of my [courses](https://courses.maximeduhamel.com/). This is the only way I will distribute it, so you might want to check them out if you are interested in it !