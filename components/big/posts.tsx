        ...
        <div>
            {allBlogs
                ...
                .map((post) => (
                    <Link
                        key={post.slug}
                        className="duration-1000 flex flex-col space-y-1 mb-4 p-4 rounded border border-neutral-200 md:border-transparent lg:hover:border-neutral-200 dark:lg:hover:border-neutral-500"
                        href={`/blog/${post.slug}`}
                    >
