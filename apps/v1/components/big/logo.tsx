...
export default function Logo({ className, size=16 } : Readonly<{ className?: string, size?: number }>) {
    return (
        <Link href="/" className={cn('inline-block duration-1000 lg:group-hover/Logo:rotate-90 shrink-0', className)}>
